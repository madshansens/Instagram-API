...
class AutoResponseFunctionSetter {
    function __call($function,$args) {
        ...
        switch ($functionType) {
            case "get":
                if (!property_exists($this,$propName)) { throw new \Exception("Wrong function $function");}
            ...
            case "set":
                ...
                break;
            case "is":
                if (!property_exists($this,$underScoreNames)) { throw new \Exception("Wrong function $function");}
