...
class SettingsMysql
{
    ...
    var $tableName = "_instagram_settings";
    ...
    function populateObject() {
        ...
        $std->execute(array(":username"=>$this->instagramUsername));
    ...
    function autoInstall() {
        ...
        $std->execute(array(":tableName" => $this->tableName));
        if ($std->rowCount()) {
            return true;
        }
    ...
    {
        if ($key == 'sets' or $key == 'pdo' or $key == 'instagramUsername') return;
